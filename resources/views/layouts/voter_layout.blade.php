...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark top-bar">
    <a class="navbar-brand" href="{{route('homepage')}}">Voter Panel</a>
    <div class="navbar-nav mx-auto">
      <a class="nav-link" href="{{route('homepage')}}"><i class="fas fa-chart-bar"></i> Dashboard</a>
      <a class="nav-link" href="#"><i class="fas fa-users"></i> Profile</a>
      <a class="nav-link" href="#"><i class="fas fa-cogs"></i> Settings</a>
      <a class="nav-link" href="#"><i class="fas fa-bell"></i> Notifications</a>
      <a class="nav-link" href="#"><i class="fas fa-envelope"></i> Events</a>
    </div>
    <div>
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <a class="dropdown-item" href="">Cast Vote</a>
                  <a class="dropdown-item" href="#">Voting Reports</a>
                </div>
              </li>
